...
const lista_times_jogadores = atom({
    key: "lista_times_jogadores", default: {
        timeA: [], timeB: []
    }
});
const jogador_selecionado = atom({
    key: "jogador_selecionado", default: {}
});
...
const referencia_partida = atom({
    key: "referencia_partida", default: {
        torneio_id: null, teamA_id: null, teamB_id: null, partida_id: null
    }
});
const jogadores_state = atom({
    key: "jogadores", default: {
        timeA: [{
            nome: 'ANTONINO PRAXEDES',
            stats: {
                cesta_1: 0, cesta_2: 0, cesta_3: 0, faltas: 0, rebotes: 0, assistencias: 0, roubos: 0, tocos: 0
