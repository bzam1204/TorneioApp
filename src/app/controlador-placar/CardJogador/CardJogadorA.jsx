...
export default function CardJogadorA({index}) {
    ...
    function changeNomeJogador(e, _index,) {
        setJogadores((prev) => {
            ...
            novo_timeA[_index] = {
                ...novo_timeA[_index], nome: e.target.textContent
            }
            console.log(e.target.textContent)
            return {
                ...prev, timeA: novo_timeA,
            }
        })
        ...
        return {
            cesta_um(_index, pontuacao_a_modificar) {
                setJogadores((prev) => {
                    const novo_timeA = [...prev.timeA]
                    novo_timeA[_index] = {
                        ...novo_timeA[_index], pontuacao: novo_timeA[_index].pontuacao + pontuacao_a_modificar, stats: {
                ...
                setJogadores((prev) => {
                    ...
                    novo_timeA[_index] = {
                        ...novo_timeA[_index], stats: {
                            ...novo_timeA[_index].stats, faltas: novo_timeA[_index].stats.faltas + pontuacao_a_modificar
                        }
                    }
                ...
                setJogadores((prev) => {
                    ...
                    novo_timeA[_index] = {
                        ...novo_timeA[_index], stats: {
                            ...novo_timeA[_index].stats, roubos: novo_timeA[_index].stats.roubos + pontuacao_a_modificar
                        }
                    }
                ...
                setJogadores((prev) => {
                    ...
                    novo_timeA[_index] = {
                        ...novo_timeA[_index], stats: {
                            ...novo_timeA[_index].stats, tocos: novo_timeA[_index].stats.tocos + pontuacao_a_modificar
                        }
                    }
    ...
    function desfazerRoubo(event) {
        event.preventDefault();
        if (jogadores.timeA[index].stats.roubos >= 1) changePontuacao().roubo(index, -1)
    }
    ...
    return (<Card_jogador id={`timeA${jogadores.timeA[index].nome}${index}`}>
        ...
        {showStats === true ? (<>
            <div style={{
                ...
                <BotaoStats
                    ...
                    onClick={function () {
                        setJogadores(prev => {
                            let jogadores_timeA = [...prev.timeA]
                            jogadores_timeA.splice(index, 1)
                            return {...prev, timeA: [...jogadores_timeA]}
                        })
                    }}
