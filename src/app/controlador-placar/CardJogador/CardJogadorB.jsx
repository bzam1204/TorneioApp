...
import {
    Botao, BotaoStats, Card_jogador, IconeBotao, ImagemJogador, NomeJogador, TextoBotao
...
export default function CardJogadorA({index}) {
    ...
    function changeNomeJogador(e, _index,) {
        setJogadores((prev) => {
            ...
            novo_timeB[_index] = {
                ...novo_timeB[_index], nome: e.target.textContent
            }
            console.log(e.target.textContent)
            return {
                ...prev, timeB: novo_timeB,
            }
        })
        ...
        return {
            cesta_um(_index, pontuacao_a_modificar) {
                setJogadores((prev) => {
                    const novo_timeB = [...prev.timeB]
                    novo_timeB[_index] = {
                        ...novo_timeB[_index], pontuacao: novo_timeB[_index].pontuacao + pontuacao_a_modificar, stats: {
                ...
                setJogadores((prev) => {
                    ...
                    novo_timeB[_index] = {
                        ...novo_timeB[_index], stats: {
                            ...novo_timeB[_index].stats, faltas: novo_timeB[_index].stats.faltas + pontuacao_a_modificar
                        }
                    }
                ...
                setJogadores((prev) => {
                    ...
                    novo_timeB[_index] = {
                        ...novo_timeB[_index], stats: {
                            ...novo_timeB[_index].stats, roubos: novo_timeB[_index].stats.roubos + pontuacao_a_modificar
                        }
                    }
                ...
                setJogadores((prev) => {
                    ...
                    novo_timeB[_index] = {
                        ...novo_timeB[_index], stats: {
                            ...novo_timeB[_index].stats, tocos: novo_timeB[_index].stats.tocos + pontuacao_a_modificar
                        }
                    }
    ...
    function desfazerRoubo(event) {
        event.preventDefault();
        if (jogadores.timeB[index].stats.roubos >= 1) changePontuacao().roubo(index, -1)
    }
    ...
    useEffect(function () {
        ...
        function toShowStats(e) {
            setShowStats(true)
        }

        function toHideStats(e) {
            setShowStats(false)
        }

        card_jogador.addEventListener('mouseover', toShowStats)
        card_jogador.addEventListener('mouseleave', toHideStats)
        return () => {
            if (card_jogador) {

                card_jogador.removeEventListener("mouseover", toShowStats)
                card_jogador.removeEventListener("mouseleave", toHideStats)
            }
        }
    }, [])


    return (<Card_jogador id={`timeB${jogadores.timeB[index].nome}${index}`}>
        ...
        {showStats === true ? (<>
            <div style={{
                ...
                <BotaoStats
                    ...
                    onClick={function () {
                        setJogadores(prev => {
                            let jogadores_timeB = [...prev.timeB]
                            jogadores_timeB.splice(index, 1)
                            return {...prev, timeB: [...jogadores_timeB]}
                        })
                    }}
            ...
            <div style={{display: "flex", justifyContent: 'flex-start', border: '0px solid #FFF;'}}>
                ...
                <div style={{
                    ...
                    <Botao>
                        <TextoBotao>{jogadores.timeB[index].pontuacao}</TextoBotao>
